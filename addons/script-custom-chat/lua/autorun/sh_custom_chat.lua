...
CustomChat.MAX_MESSAGE_LENGTH = 800

-- Max. number of characters in a channel ID
CustomChat.MAX_CHANNEL_ID_LENGTH = 300
...
CreateConVar( "custom_chat_safe_mode", "1", bit.bor( FCVAR_ARCHIVE, FCVAR_REPLICATED, FCVAR_NOTIFY ),
