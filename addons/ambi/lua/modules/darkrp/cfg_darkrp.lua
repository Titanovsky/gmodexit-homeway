...
Ambi.DarkRP.Config.restrict_spawn_ragdolls = 0 -- Запреты на спавн Рэгдоллов
Ambi.DarkRP.Config.restrict_spawn_effects = 0 -- Запреты на спавн Эффектов
Ambi.DarkRP.Config.restrict_spawn_entities = 0 -- Запреты на спавн Энтити
Ambi.DarkRP.Config.restrict_spawn_weapons = 0 -- Запреты на спавн/выдачу Оружия
Ambi.DarkRP.Config.restrict_spawn_npcs = 0 -- Запреты на спавн NPC
Ambi.DarkRP.Config.restrict_spawn_vehicles = 0 -- Запреты на спавн Транспортных Средств
Ambi.DarkRP.Config.restrict_use_properties = 0 -- Запреты на использования функций из С меню (Свойства)
...
Ambi.DarkRP.Config.restrict_use_mass_unfreeze_physgun = 0 -- Запреты на массовый расфриз через R
Ambi.DarkRP.Config.restrict_use_unfreeze_physgun = 2 -- Запреты на расфриз
Ambi.DarkRP.Config.restrict_use_punt_gravgun = 2 -- Запреты на бросок с помощью гравити гана
...
Ambi.DarkRP.Config.chat_voice_3d = true -- Войс будет в формате 3D? 
...
Ambi.DarkRP.Config.player_base_walkspeed = 180 -- Скорость ходьбы
Ambi.DarkRP.Config.player_base_runspeed = 290 -- Скорость бега
Ambi.DarkRP.Config.player_base_maxspeed = 220 -- Скорость максимальная
...
Ambi.DarkRP.Config.player_payday_log = false -- Логгировать в чат о том, что зарплата получена?
...
Ambi.DarkRP.Config.player_fall_damage_divided_by = 18 -- На какое число поделить скорость? Рассчёт урона от падения = Скорость / player_fall_damage_divided_by
...
Ambi.DarkRP.Config.rpname_can_use_command = false -- Игроки могут изменить через чатовую команду своё имя?
...
Ambi.DarkRP.Config.jobs_class = 'j_citizen' -- Класс работы, которая будет даваться при заходе на сервер
...
Ambi.DarkRP.Config.jobs_change_on_chat_command = false -- Можно ли менять профессию через чатовую команду (например: /citizen, /police)
...
Ambi.DarkRP.Config.jobs_delay = 5 -- Задержка появляется после становления на работу. Пока она есть, на другую нельзя встать (Исключение, насильно изменить работу)
Ambi.DarkRP.Config.jobs_can_change_name = false -- Можно ли с помощью команды поменять название работы?
...
Ambi.DarkRP.Config.jobs_maker_enable = false -- Включить систему Job Maker? Также будут создаваться сохранённые работы при инициализаций модуля DarkRP --![НУЖЕН РЕСТАРТ]
...
Ambi.DarkRP.Config.shop_sell_enable = false -- Включить возможность Продажи?
...
Ambi.DarkRP.Config.shop_maker_enable = false -- Включить систему Shop Maker? Также будут создаваться сохранённые работы при инициализаций модуля DarkRP --![НУЖЕН РЕСТАРТ]
...
Ambi.DarkRP.Config.doors_cost_buy = 500 -- Сумма, за которую можно купить дверь
Ambi.DarkRP.Config.doors_cost_sell = 250 -- Сумма, которая вернётся за продажу
...
Ambi.DarkRP.Config.doors_draw_info_max_length = 450 -- Максимальное расстояние показа информаций о двери

Ambi.DarkRP.Config.doors_draw_info_2d = false -- Показывать инфу, когда игрок наводится на дверь (2D)
Ambi.DarkRP.Config.doors_draw_info_2d_pos = 'top' -- Позиций для инфы: top, bottom, left, right, center.

Ambi.DarkRP.Config.doors_categories_create_defaults = false -- Добавить дефолтные категорий для дверей, работает с включённым jobs_create_defaults
...
Ambi.DarkRP.Config.money_start = 15000 -- Стартовый запас денег

Ambi.DarkRP.Config.money_drop_can = true -- Можно ли выкидывать валюту в виде энтити? Работает только на команды (чат, консоль)
Ambi.DarkRP.Config.money_drop_entity_class = 'homeway_money' -- Валюта дропнется в виде какой энтити?
...
Ambi.DarkRP.Config.money_drop_delay = 5 -- Задержка в секундах для дропа валюты 
Ambi.DarkRP.Config.money_drop_min = 1000 -- Минимальное число дропа
...
Ambi.DarkRP.Config.f4menu_show_home = false -- Будет работать страница Основное? 
Ambi.DarkRP.Config.f4menu_show_jobs = false -- Будет работать страница Работы? 
Ambi.DarkRP.Config.f4menu_show_shop = false -- Будет работать страница Магазина?  
Ambi.DarkRP.Config.f4menu_show_settings = false -- Будет работать страница Настройки? 
Ambi.DarkRP.Config.f4menu_show_commands = false -- Будет работать страница Команды? 
...
Ambi.DarkRP.Config.hud_3d_enable = false -- Включить 3D HUD над головой игроков
...
--* ====================================================================================================================================================== --
Ambi.DarkRP.Config.cmenu_enable = false -- Включить DarkRP C-Menu
Ambi.DarkRP.Config.cmenu_show_laws = false -- Показать Законы?
...
--* ====================================================================================================================================================== --
Ambi.DarkRP.Config.positions_enable = false -- Включить Сохранённые Позиций? (Не путать с job.spawns, они никак не связаны! Притом тюремные точки будут работать)
...
Ambi.DarkRP.Config.police_system_arrest_can_other_police = false -- Игрок может арестовать игроков с работой, у которых job.police?
...
Ambi.DarkRP.Config.police_system_arrest_delay = 5 -- Задержка в секундах между арестами
Ambi.DarkRP.Config.police_system_arrest_distance = 80 -- Дистанция для ареста
Ambi.DarkRP.Config.police_system_arrest_time = 250 -- Сколько тюрьма будет длится в секундах
...
Ambi.DarkRP.Config.police_system_wanted_time = 60 * 10 -- Сколько игрок будет в розыске (если 0, то всегда)
...
Ambi.DarkRP.Config.police_system_warrant_delay = 30 -- Задержка на Ордер на Обыск?
Ambi.DarkRP.Config.police_system_warrant_time = 60 * 3 -- Сколько Ордер будет действовать?
Ambi.DarkRP.Config.police_system_warrant_delay_door_ram = 5 -- Задержка у Полицейского на следующее Выламывание Двери?
...
Ambi.DarkRP.Config.goverment_lockdown_delay = 120 -- Задержка в секундах для старта Ком. Часа?
Ambi.DarkRP.Config.goverment_lockdown_time = 60 * 15 -- Время до Окончания Ком. Часа? (Если 0, то пока не выключат)
...
Ambi.DarkRP.Config.lockpick_can_keypad = false -- Можно взламывать кейпады?
