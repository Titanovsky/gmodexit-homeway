...
function Ambi.DarkRP.SetLockdown( bStart, sReason )
    ...
    if bStart and string.IsValid( Ambi.DarkRP.Config.goverment_lockdown_sound ) then
        ...
        Ambi.DarkRP.SetLockdownReason( sReason )
    end
    ...
    hook.Call( '[Ambi.DarkRP.SetLockdown]', nil, bStart, sReason )
end

function Ambi.DarkRP.SetLockdownReason( sReason )
    SetGlobal2String( 'ambi_lockdown_reason', sReason or '' )
end
