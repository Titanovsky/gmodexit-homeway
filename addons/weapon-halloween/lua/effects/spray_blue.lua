...
function EFFECT:Init( data )
	...
	for i = 1, 12 * self.Scale do
		local particle = teh_effect:Add( "models/weapons/monstermash/webgrenade/web_floor", self.Position )
		if ( particle ) then
			...
			particle:SetCollideCallback( function( particleC, HitPos, normal )
				...
				particleC:SetDieTime( 5 )
				particleC:SetStartSize( 16 )
				particleC:SetEndSize( 16 )
				particleC:SetStartAlpha( 128 )
				particleC:SetEndAlpha( 128 )
			end )
		end
	end
