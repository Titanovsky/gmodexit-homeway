...
if CLIENT then
	...
	SWEP.PrintName			= "Beam Gun"
	SWEP.Author				= "Upset"
	SWEP.Slot				= 3
	SWEP.SlotPos			= 3
	SWEP.ViewModelFOV		= 67
	SWEP.WepIcon			= surface.GetTextureID("interface/weaponicons/beamgun")
...
function SWEP:SpecialThink()
	...
	if self:IsMaxSpin() and (!self.Owner:KeyDown(IN_ATTACK) or self:GetAmmo() <= 0) then
...
SWEP.Primary.Damage			= 25 -- dunno actual dmg
