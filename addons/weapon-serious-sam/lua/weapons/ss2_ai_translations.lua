...
function SWEP:SetupWeaponHoldTypeForAI(t)
	...
	if t == "ar2" or self:GetClass() == "weapon_ss2_minigun" or self:GetClass() == "weapon_ss2_sniper" then
	...
	elseif t == "shotgun" or t == "crossbow" and self:GetClass() != "weapon_ss2_plasmarifle" then
	...
	elseif t == "smg" or self:GetClass() == "weapon_ss2_plasmarifle" then
